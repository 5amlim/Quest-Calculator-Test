window.SEED_TESTS = [
  ...
  },
  {
    ...
    "specimenType": "Urine",
    "drawContainer": "Red/Yellow Swirl UA Tube + Gray-Top Culture Tube",
    "alternativeContainer": "Yellow-cap UA pour-off tube + UriSponge™ (verify Quest)",
    "transportContainer": "Submit both preservative tubes",
    "preferredVolume": "UA tube: 10 mL; culture tube: 4 mL",
    "minimumVolume": "Fill UA tube to its indicated line; fill gray-top culture tube to its minimum line",
    "transportTemperature": "Room Temperature",
    "transportTemperatureRaw": "Room temperature",
    "stability": "Verify current Quest directory",
    "spin": "No",
    "specialInstructions": "Collect and submit both preservative tubes from the same urine specimen: 1) red/yellow swirl-top urinalysis tube with preservative for UA, and 2) gray-top urine culture tube with preservative for culture. Fill each tube to its marked fill line. Both tubes are required for UA with reflex to culture.",
    "status": "active",
